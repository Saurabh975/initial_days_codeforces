...
public class pashmakProblem {
    ...
    static void Blackrise() {                                                //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        int pre_1_to_i[]=new int[n];
        int suf_j_to_n[]=new int[n];
        BIT=new int[2000005];
        ...
        for(int i=n-1;i>=0;i--)
        {
            ...
            //pl(map.get(ar[i]));
            suf_j_to_n[i]=map.get(ar[i]);
            res+=result(pre_1_to_i[i]-1);

            update(suf_j_to_n[i],n);
        }
        pl(res);
    ...
    static void update(int x,int n)
    {
