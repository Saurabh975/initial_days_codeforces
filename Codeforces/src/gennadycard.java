...
public class gennadycard {
    ...
    static void TERA_BHI_KATEGA() {
        ...
        for(int i=0;i<5;i++)
        {
            char c[]=ns().toCharArray();c1.add(c[0]);c2.add(c[1]);
        }
        if(c1.contains(ch[0])|| c2.contains(ch[1]))pl("YES");
        else pl("NO");
    ...
    //IT'S JAVA SO YOU KNOW CERTAIN STUFF YOU DONT NEED TO BOTHER ABOUT :p .//
    ...
    public static void main(String[] args) {                                 //threading has been used to increase the stack size.
        ...
        new Thread(null, null, "E raja raja raja, kareja me samaja", 1 << 25)  //the last parameter is stack size which is desired,
        {
            public void run() {
