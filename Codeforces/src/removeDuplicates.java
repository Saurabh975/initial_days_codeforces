...
public class removeDuplicates {
    ...
    static void Blackrise() {                                                //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        int ar[]=new int[1001];
        for(int i=0;i<n;i++)index[ni()]=i+1;
        for(int i=1;i<1001;i++)if(index[i]!=0)ar[index[i]]=i;
        int c=0;
        for(int i=0;i<1001;i++)if(ar[i]!=0)c++;pl(c);for(int i=0;i<1001;i++)if(ar[i]!=0)p(ar[i]);
        pl();
