...
public class commonDivisors {
    ...
    static void Bolo_Jai_Mata_Di() {
        ...
        StringBuilder s1 = new StringBuilder(ns());
        StringBuilder s2 = new StringBuilder(ns());
        ...
        for(int i=1;i<=n;i++)
        {
            ...
            {
                int flag1=0,flag2=0;
                for(int j=0;j<s1.length();j++)if(s1.charAt(j)!=s1.charAt(j%i)){flag1=1;break;}
                for(int j=0;j<s2.length() && flag1!=1;j++)if(s2.charAt(j)!=s1.charAt(j%i)){flag2=1;break;}
