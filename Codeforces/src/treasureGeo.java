...
public class treasureGeo {
    ...
    static void Blackrise() {                                                //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        Comparator<two> c1=new Comparator<two>() {
            @Override
        ...
        Comparator<two> c2=new Comparator<two>() {
            @Override
            public int compare(two o1, two o2) {
                return o1.a==o2.a?o2.b-o1.b:o2.a-o1.a;
            }
        };
        ...
        Arrays.sort(a,c1);Arrays.sort(b,c2);
        pl(a[0].a+b[0].a+" "+(a[0].b+b[0].b));
